...
export class LanguageMarathonController {
  constructor(
    ...
    private readonly classroomService: AbstractLanguageMarathonService,
  ) {}
  ...
  create(
    ...
    return this.classroomService.create(dto, code);
  }
  ...
  findAllByClassroomCode(
    ...
    return this.classroomService.findAllByClassroomCode(code);
  }
  ...
  update(
    ...
    return this.classroomService.update(id, updateDto);
  }
